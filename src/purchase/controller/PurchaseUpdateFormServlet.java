...
/**
 * Servlet implementation class PurchaseUpdateFormServlet
 */
@WebServlet("/PurchaseUpdateFormServlet")
public class PurchaseUpdateFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PurchaseUpdateFormServlet() {
        super();
