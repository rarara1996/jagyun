...
※ 제주도 3000원, 제주도 외 도서산간 2000원
			...
			<div id="wrap">
				<table class="tablee">
					...
					<tr>
						...
						</select>- <input type="text" name="tel2" id="tel2" class="text" maxlength="4">- <input type="text" name="tel3" id="tel3"
			...
			<div id="wrap">
				<table class="tablee">
					...
					<tr>
						<td>*주소</td>
						<td><input type="text" id="sample6_postcode" class="text"
							placeholder="우편번호"> &nbsp;
					...
					<tr>
						<td></td>
						<td><input type="text" id="sample6_address" class="textt"placeholder="주소"></td>
					</tr>
					<tr>
					<td></td>
					<td><input type="text"id="sample6_detailAddress" class="textt" placeholder="상세주소"></td>
					</tr>
				</table>
			</div>
			<br>
			...
			<!-- 약관 -->
				<div>
					...
					<label>동의</label>&nbsp;<input type="checkbox" id="exampleCheck1"><span
						id="checkedtext1"></span>
				</div>
				<div>
					...
					<label>동의</label>&nbsp;<input type="checkbox" id="exampleCheck2"><span
						id="checkedtext2"></span>
				</div>
				<br>
				<br>
				<div>
