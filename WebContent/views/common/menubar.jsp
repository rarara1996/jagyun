...
<body class="menubarbody">
	...
	<nav class="navbarM navbarM-expandM fixed-top">
		<div class="container">
			...
			<img 	width="70%",
	height="70%", src="<%= request.getContextPath() %>/resources/image/logo.jpg"></a>
			...
			<div class="collapseM navbarM-collapseM" id="navbarMResponsive">
				<ul class="navbarM-nav ml-auto">
					...
					<li class="nav-itemM" id="nav-itemM">
						<!-- //메인 --> <a class="nav-linkM" href="<%= request.getContextPath() %>/views/common/main.jsp">
						<img
					...
					<li class="nav-itemM">
						<!-- //마켓 --> <a class="nav-linkM" href="<%= request.getContextPath() %>/views/ProductBoard/ProductBoard.jsp"><img
