			...
			<div class="row">
				...
				<div id="content" class="8u skel-cell-important">
					<section>
						...
						<a href="#" class="image full"><img
							src="<%= request.getContextPath() %>/resources/image/dog7.jpg"
							alt="" /></a>


						<p>
							우리 <strong>견자단은</strong>댕댕이를 사람과 같이 생각합니다.
						</p>
						<p>반려동물은 ‘가슴으로 만든 가족’ 입니다. 우리와 삶을 함께하며 기쁨과 즐거움, 행복과 사랑을 안겨준 이
							세상 무엇으로도 대신할 수 없는 소중한 선물입니다. 최고의 서비스와 깜짝 선물로 고마운 마음을 전하세요.ㅋㅋzzz
						</p>
					</section>
				</div>
				...
				<div id="sidebar" class="4u">
					<section>
						...
						<ul class="style">
							<li>
								<p class="posted">펫시터란?</p> <img
								src="<%= request.getContextPath() %>/resources/image/dog2.png"
								width="70px" height="70px" alt="" />
								<p class="text">집에 혼자있는... (펫시터정보 요약)</p>
							</li>
							<li>
								<p class="posted">이번달 최고의 펫시터</p> <img
								src="<%= request.getContextPath() %>/resources/image/dog3.jpg"
								width="70px" height="70px" alt="" />
								<p class="text">김김김 펫시터님(후기보기)</p>
							</li>
							<li id="ps-apply">
								<p class="posted">펫시터 지원하기</p> <img
		...
		<div class="container">
			<div class="row">
				<div class="4u">
					<h2>자유게시판</h2>
					<a
						href="<%= request.getContextPath() %>/views/board/board/board.jsp"
				...
				<div class="4u">
					<h2>반려견 스토리</h2>
					<a
						href="<%= request.getContextPath() %>/views/board/imageBoard/imageBoard.jsp"
						class="image full"><img
						src="<%= request.getContextPath() %>/resources/image/dog6.jpg"
						width="380px" height="160px" alt="" /></a>
				...
				<div class="4u">
					<h2>공지사항</h2>
					<a
						href="<%= request.getContextPath() %>/views/board/notice/notice.jsp"
						class="image full"><img
						src="<%= request.getContextPath() %>/resources/image/dog7.jpg"
						width="380px" height="160px" alt="" /></a>
					<p>새로운 내용을 확인하세요!</p>
