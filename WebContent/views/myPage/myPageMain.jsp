						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card mb-12">
									...
									<br> <strong><p><%=loginUser.getUserName()%>
											회원님 환영합니다!
										</p></strong>
									<div id="hr">
										<hr>
									...
									<div class="selectList">
										...
										<div id="petPic">
											...
											<br>
											<br><%=loginUser.getUserName()%>
											(<%=loginUser.getUserId()%>)<br>
											<br>
											<button class="mpButton" id="mpPwUpdate"
												onclick="myPwdUpdate();">비밀번호 변경</button>
											&nbsp;&nbsp;&nbsp;&nbsp;
											<button class="mpButton" id="mpPetUpdate"
												onclick="myPetInfo();">반려견 관리</button>
											&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<br> <a
											...
											class="select"></a> <a
											href="<%=request.getContextPath()%>/views/myPage/board/mpBoardList.jsp"><img
											src="<%=request.getContextPath()%>/resources/mypage/image/mpBoardList.png"
											class="select"></a> <a
											href="<%=request.getContextPath()%>/views/myPage/market/myMarketList2.jsp"><img
										...
										<a href="javascript:psCheck()"><img
											...
											class="select"></a> <a
											href="<%=request.getContextPath()%>/views/myPage/petSitter/myPetSitterList.jsp"><img
											src="<%=request.getContextPath()%>/resources/mypage/image/mpPetsitterService.png"
											class="select"></a> <a
											href="<%=request.getContextPath()%>/views/myPage/report/myReportList.jsp"><img
		...
		url : "<%=request.getContextPath()%>/CheckPs", //CheckPs로 감
						success : function(data) { //연결 성공시
							...
							case "ps-ok": //승인 완료
								console.log("승인 완료")
								location.href = "
	<%= request.getContextPath() %>/views/myPage/petSitter/petSitterPage1.jsp";
				break;
			case "not-yet": //승인 대기
