                            ...
                            <div class="boardView">
                                <table border="1" summary="">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">작성자</th>
                                            <td>유수완<span class="displaynone">(ip:)</span> </td>
                                        </tr>
    ...
    -->
                        <ul class="boardComment">
                            <li class="first xans-record-">
                                ...
                                <p class="comment">
                                    <span id="comment_contents70020">zz</span> </p>
                            </li>
                        </ul>
...
<div class="btnArea">
                                <a href=""><img src="" alt="목록" /></a>
                                <a href="" onclick="" class=""><img src="" alt="삭제" /></a>
                                <a href="/board/free/modify.html?board_act=edit&no=1372630&board_no=1" class=""><img
                                        src="" alt="수정" /></a>
                            </div>
                    </div>
