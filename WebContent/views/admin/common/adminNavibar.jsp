    ...
    <!-- 마켓 관리 ▶ 판매 관리, 판매 물품 작성, 주문 취소 내역-->
      <li class="nav-item" id="market">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/market/adMarketList.jsp" id="marketad">판매 관리</a>
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/market/adMarketInsert.jsp" id="marketInsert">판매 물품 작성</a>
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/market/adMarketCancel.jsp" id="marketCancel">주문취소 내역</a>
          </div>
        </div>
      </li>
    ...
    <!-- 게시판 관리 ▶ 일반 게시판 관리, 사진 게시판 관리, 댓글 관리, 1:1 문의 관리-->
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/board/adboardList.jsp" id="board">일반 게시판 관리</a>
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/board/adPicBoardList.jsp" id="pic">사진 게시판 관리</a>
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/board/adCommnetList.jsp" id="comment">댓글 관리</a>
            <a class="collapse-item" href="<%= request.getContextPath() %>/views/admin/board/adQnAList.jsp" id="boardQnA">1:1 문의 관리</a>
          </div>
        </div>
      </li>
